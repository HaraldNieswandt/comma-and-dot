    ...
    begin
      ...
      begin
        ...
        begin
          ...
          { Sonst, wenn das erste Zeichen ein Minus ist, muss das Minus hinter das e: }
          //if PosEx('-', Text) = 1 then SelStart := PosEx('e', Text) else
          { Ist Cursorposition das "e", dann das Minus hinter das "e" }
          if CaretPos.x <> PosEx('e', Text) then Key := #0;
        end else
